...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/js/bootstrap.bundle.min.js">
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#aboutmenu">About</a></li>
                        ...
                        -->
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li><a>Features Page 4</a></li>
                                </ul>
                            </li>
                            <!-- <li class=""><a rel="sponsored" href="https://templatemo.com" target="_blank">External URL</a></li> -->
                            <li class="scroll-to-section"><a href="#cantactUs">Contact Us</a></li> 
...
@endguest
    ...
    <!-- ***** About Area Starts ***** -->
    <section class="section" id="aboutmenu">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-xs-12">
                    <div class="right-text-content">
                            <ul class="social-icons">
                                ...
                                <li><a href="https://t.me/Azamat_team_leader"><i class="fa fa-send"></i></a></li>
